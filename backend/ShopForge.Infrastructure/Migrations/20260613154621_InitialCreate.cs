        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameEs = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
                    DescriptionEs = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinSubtotal = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginEs = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    Region = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    AltitudeMeters = table.Column<int>(type: "int", nullable: true),
                    RoastLevel = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Process = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    FlavorNotes = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    FlavorNotesEs = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    DescriptionEs = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    HeroLabel = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    HeroLabelEs = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ship_FullName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    ...
                    Ship_Country = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    Ship_Phone = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    SortOrder = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SizeEs = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VariantSize = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    Grind = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_CartId_ProductVariantId_Grind",
                table: "CartItems",
                columns: new[] { "CartId", "ProductVariantId", "Grind" });
